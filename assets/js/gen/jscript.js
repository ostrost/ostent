...
var disksinBytesClass = React.createClass({displayName: 'disksinBytesClass',
	...
	render: function() {
		...
		return (React.DOM.table( {className:"table1 stripe-table"}, React.DOM.thead(null, React.DOM.tr(null, React.DOM.th( {className:"header"},         "        ",        React.DOM.a( {href:Data.DiskLinks.DiskName.Href, className:Data.DiskLinks.DiskName.Class}, "Device")),React.DOM.th( {className:"header"},         "        ",        React.DOM.a( {href:Data.DiskLinks.DirName.Href,  className:Data.DiskLinks.DirName.Class}, "Mounted")),React.DOM.th( {className:"header digital"}, React.DOM.a( {href:Data.DiskLinks.Avail.Href,    className:Data.DiskLinks.Avail.Class}, "Avail")),React.DOM.th( {className:"header digital"}, React.DOM.a( {href:Data.DiskLinks.Used.Href,     className:Data.DiskLinks.Used.Class}, "Used")),React.DOM.th( {className:"header digital"}, React.DOM.a( {href:Data.DiskLinks.Total.Href,    className:Data.DiskLinks.Total.Class}, "Total")))),React.DOM.tbody(null, rows)));
