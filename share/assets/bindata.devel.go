...
// js_devel_vendor_min_react_0_11_1_react_min_js reads file data from disk. It returns an error on failure.
func js_devel_vendor_min_react_0_11_1_react_min_js() ([]byte, error) {
	return bindata_read(
		"share/assets/js/devel/vendor/min/react/0.11.1/react.min.js",
		"js/devel/vendor/min/react/0.11.1/react.min.js",
	)
}
