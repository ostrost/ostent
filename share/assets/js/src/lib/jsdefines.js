define(function(require) {
  ...
  , React.createElement("div", {className: Data.Params.BOOL.hidemem.Value ? "collapse-hidden" : ""
    ...
    , React.createElement("div", {id: "ifconfig", className: Data.Params.BOOL.configif.Value ? "" : "collapse-hidden"
      ...
      }, React.createElement("li", {className: (Data.Params.ENUM.ift.Uint == 0) ? "active" : ""
        }, React.createElement("a", {href: Data.Params.ENUM.ift.PACKETS.Href, onClick: this.handleClick
  }, "Packets")), React.createElement("li", {className: (Data.Params.ENUM.ift.Uint == 1) ? "active" : ""
        }, React.createElement("a", {href: Data.Params.ENUM.ift.ERRORS.Href, onClick: this.handleClick
  }, "Errors")), React.createElement("li", {className: (Data.Params.ENUM.ift.Uint == 2) ? "active" : ""
  ...
  , React.createElement("div", {className: Data.Params.BOOL.hideif.Value ? "collapse-hidden" : ""
    }, React.createElement("div", {className: (Data.Params.ENUM.ift.Uint == 0) ? "" : "collapse-hidden"
      }, React.createElement("table", {className: "table1 stripe-table"
  }, React.createElement("thead", null
    , React.createElement("tr", null
      , React.createElement("th", null
    ...
    , r1))), React.createElement("div", {className: (Data.Params.ENUM.ift.Uint == 1) ? "" : "collapse-hidden"
      }, React.createElement("table", {className: "table1 stripe-table"
  }, React.createElement("thead", null
    , React.createElement("tr", null
      , React.createElement("th", null
    ...
    , r2))), React.createElement("div", {className: (Data.Params.ENUM.ift.Uint == 2) ? "" : "collapse-hidden"
      }, React.createElement("table", {className: "table1 stripe-table"
  }, React.createElement("thead", null
    , React.createElement("tr", null
      , React.createElement("th", null
  ...
  , React.createElement("span", {className: "label", "data-usepercent": $disk.IusePercent
    ...
    , React.createElement("div", {id: "dfconfig", className: Data.Params.BOOL.configdf.Value ? "" : "collapse-hidden"
      ...
      }, React.createElement("li", {className: (Data.Params.ENUM.dft.Uint == 0) ? "active" : ""
        }, React.createElement("a", {href: Data.Params.ENUM.dft.INODES.Href, onClick: this.handleClick
  }, "Inodes")), React.createElement("li", {className: (Data.Params.ENUM.dft.Uint == 1) ? "active" : ""
  ...
  , React.createElement("div", {className: Data.Params.BOOL.hidedf.Value ? "collapse-hidden" : ""
    }, React.createElement("div", {className: (Data.Params.ENUM.dft.Uint == 0) ? "" : "collapse-hidden"
      }, React.createElement("table", {className: "table1 stripe-table"
  }, React.createElement("thead", null
    , React.createElement("tr", null
    ...
    , r1))), React.createElement("div", {className: (Data.Params.ENUM.dft.Uint == 1) ? "" : "collapse-hidden"
      }, React.createElement("table", {className: "table1 stripe-table"
  }, React.createElement("thead", null
    , React.createElement("tr", null
      , React.createElement("th", {className: "header "
