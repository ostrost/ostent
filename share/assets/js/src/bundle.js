...
/***/ function(module, exports, __webpack_require__) {
	...
	function sl(i) {
	  return React.createElement(sparklines, { ref: i });
	}
	...
	jsdefines.define_panelcpu = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return _jsx('div', {}, void 0, _jsx('div', {
	      ...
	      className: 'text-right'
	    }, void 0, 'Idle%'))), _jsx('tbody', {}, void 0, this.List(Data).map(function ($cpu) {
	...
	jsdefines.define_paneldf = React.createClass({
	  ...
	  render: function render() {
	    ...
	    }))))), _jsx('tbody', {}, void 0, this.List(Data).map(function ($df) {
	...
	jsdefines.define_panelmem = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return _jsx('div', {}, void 0, _jsx('div', {
	      ...
	      className: 'text-right'
	    }, void 0, 'Use%'), _ref4)), _jsx('tbody', {}, void 0, this.List(Data).map(function ($mem, i) {
