...
func index_html() (*asset, error) {
	...
	info := bindata_file_info{name: "index.html", size: 28286, mode: os.FileMode(384), modTime: time.Unix(1400000000, 0)}
