...
func indexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.html", size: 26774, mode: os.FileMode(384), modTime: time.Unix(1400000000, 0)}
