...
func indexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.html", size: 29447, mode: os.FileMode(384), modTime: time.Unix(1400000000, 0)}
