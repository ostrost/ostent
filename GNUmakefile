...
$(templates_bingo):
	cd $(@D) && $(go-bindata) -pkg $(notdir $(@D)) -o $(@F) -tags bin -mode 0600 -modtime 1400000000 -nomemcopy ./...
$(templates_devgo):
	cd $(@D) && $(go-bindata) -pkg $(notdir $(@D)) -o $(@F) -tags '!bin' -dev ./...

$(assets_bingo):
	cd $(@D) && $(go-bindata) -pkg $(notdir $(@D)) -o $(@F) -tags bin -mode 0600 -modtime 1400000000 -ignore js/src/ -nomemcopy ./...
$(assets_devgo):
