...
var disksinBytesClass = React.createClass({
	...
	render: function() {
		...
		return (<table className="table1 stripe-table"><thead><tr><th className="header">        <a href={Data.DiskLinks.DiskName.Href} className={Data.DiskLinks.DiskName.Class}>Device<span  className={Data.DiskLinks.DiskName.CaretClass} /></a></th><th className="header">        <a href={Data.DiskLinks.DirName.Href}  className={Data.DiskLinks.DirName.Class} >Mounted<span className={Data.DiskLinks.DirName.CaretClass}  /></a></th><th className="header digital"><a href={Data.DiskLinks.Avail.Href}    className={Data.DiskLinks.Avail.Class}   >Avail<span   className={Data.DiskLinks.Avail.CaretClass}    /></a></th><th className="header digital"><a href={Data.DiskLinks.Used.Href}     className={Data.DiskLinks.Used.Class}    >Used<span    className={Data.DiskLinks.Used.CaretClass}     /></a></th><th className="header digital"><a href={Data.DiskLinks.Total.Href}    className={Data.DiskLinks.Total.Class}   >Total<span   className={Data.DiskLinks.Total.CaretClass}    /></a></th></tr></thead><tbody>{rows}</tbody></table>);
...
var procTableClass  = React.createClass({
	...
	render: function() {
		...
		return (<table className="table2 stripe-table"><thead><tr><th className="header digital"><a href={Data.ProcTable.Links.PID.Href}      className={Data.ProcTable.Links.PID.Class}     >PID<span     className={Data.ProcTable.Links.PID.CaretClass}      /></a></th><th className="header digital"><a href={Data.ProcTable.Links.User.Href}     className={Data.ProcTable.Links.User.Class}    >USER<span    className={Data.ProcTable.Links.User.CaretClass}     /></a></th><th className="header digital"><a href={Data.ProcTable.Links.Priority.Href} className={Data.ProcTable.Links.Priority.Class}>PR<span      className={Data.ProcTable.Links.Priority.CaretClass} /></a></th><th className="header digital"><a href={Data.ProcTable.Links.Nice.Href}     className={Data.ProcTable.Links.Nice.Class}    >NI<span      className={Data.ProcTable.Links.Nice.CaretClass}     /></a></th><th className="header digital"><a href={Data.ProcTable.Links.Size.Href}     className={Data.ProcTable.Links.Size.Class}    >VIRT<span    className={Data.ProcTable.Links.Size.CaretClass}     /></a></th><th className="header digital"><a href={Data.ProcTable.Links.Resident.Href} className={Data.ProcTable.Links.Resident.Class}>RES<span     className={Data.ProcTable.Links.Resident.CaretClass} /></a></th><th className="header center"> <a href={Data.ProcTable.Links.Time.Href}     className={Data.ProcTable.Links.Time.Class}    >TIME<span    className={Data.ProcTable.Links.Time.CaretClass}     /></a></th><th className="header">        <a href={Data.ProcTable.Links.Name.Href}     className={Data.ProcTable.Links.Name.Class}    >COMMAND<span className={Data.ProcTable.Links.Name.CaretClass}     /></a></th></tr></thead><tbody id="procrows">{ps_rows}</tbody></table>);
